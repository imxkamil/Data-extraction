...
def extract_identifiers(file_path):
    ...
    try:
        ...
        # Initialize result dictionary with XD for all values
        identifiers = {'KRS': "XD", 'PESEL': "XD", 'NIP': "XD", 'REGON': "XD"}

        # Loop through matches and assign the first found occurrence for each identifier
        for identifier, number in matches:
            if identifier in identifiers and identifiers[identifier] == "XD":
        ...
        return {'KRS': "XD", 'PESEL': "XD", 'NIP': "XD", 'REGON': "XD"}
...
# Path to CSV file
date = "27092024"
csv_file_path = fr'C:\Users\pdf\Desktop\monitor\test3\data\db\{date}.csv'
pdf_path = fr"C:\Users\pdf\Desktop\monitor\test3\data\raw\{date}.pdf"  # PDF path
...
with open(csv_file_path, mode='r', encoding='utf-8') as file:
    ...
    output_csv_file = fr'C:\Users\pdf\Desktop\monitor\test3\data\db\{date}-updated.csv'
...
print("All rows processed and saved to the updated CSV file.")
